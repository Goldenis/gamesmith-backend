...
trait EmailService {
  def send(to: String, subject: String, content: Content, from: String = "invited@gamesmith.com"): Boolean
}
...
trait DumbEmailModule extends EmailModule {
  val emailService = new EmailService {
    override def send(to: String, subject: String, content: Content, from: String) = {
